...
export const ProductItem = ({ product, addItem }) => {
  ...
  const authorURL = encodeURIComponent(
    author.replace(/[\s]/g, '-').toLowerCase()
  );
  const narratorURL = encodeURIComponent(
    narrator.replace(/[\s]/g, '-').toLowerCase()
  );
  const publisherURL = encodeURIComponent(
    publisher.replace(/[\s]/g, '-').toLowerCase()
  );
  return (
    <React.Fragment>
        ...
        <div className="product-item-top">
          ...
          <div className="product-details">
            ...
            <span className="product-details-text">
              ...
              <Link to={`/authors/${authorURL}`}>{author}</Link>
            </span>
            <span className="product-details-text">
              <span className="product-details-text-bold">Narrated By:</span>
              <Link to={`/authors/${narratorURL}`}>{narrator}</Link>
            </span>
            <span className="product-details-text">
            ...
            <span className="product-details-text">
              ...
              <Link to={`/authors/${publisherURL}`}>{publisher}</Link>
            </span>
            ...
            <div className="product-share">
              ...
              <div className="social-icons">
                <img
                  src="https://booklist1187.s3-us-west-1.amazonaws.com/facebook.png"
                  alt="facebook"
                />
                <img
                  src="https://booklist1187.s3-us-west-1.amazonaws.com/twitter.png"
                  alt="twitter"
                />
                <img
                  src="https://booklist1187.s3-us-west-1.amazonaws.com/pinterest.png"
                  alt="pinterest"
                />
                <img
                  src="https://booklist1187.s3-us-west-1.amazonaws.com/google-plus.png"
                  alt="google plus"
                />
                <img
                  src="https://booklist1187.s3-us-west-1.amazonaws.com/envelope.png"
                  alt="email"
                />
              </div>
            </div>
